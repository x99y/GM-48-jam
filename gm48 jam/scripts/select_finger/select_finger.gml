function select_finger(){
    ...
    // Check bounds first, outside of with
    var _in_bounds = point_in_rectangle(_mouse_x, _mouse_y,
        oHandRenderer.x, oHandRenderer.y,
        oHandRenderer.x + oHandRenderer.x_scale * oHandRenderer.base_width,
        oHandRenderer.y + oHandRenderer.y_scale * oHandRenderer.base_height
    );
	...
	for (var _j = _finger_count - 1; _j >= 0; _j--){
